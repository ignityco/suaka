        ...
        <div className="mt-4 mb-10">
          ...
          <div className="lg:grid lg:grid-cols-12 gap-x-4 mt-4">
            ...
            <div id="contact" className="lg:col-span-4">
              <p className="lg:hidden mt-10 mb-2 text-xl font-bold">Contact</p>
