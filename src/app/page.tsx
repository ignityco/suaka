  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto py-4">
        ...
        {/* ====================== Hero Banner ====================== */}
        <div className="py-2">
          <div className="relative bg-primary rounded-2xl w-full h-[500px] p-10 flex items-center">
            <div>
              <h1 className="uppercase text-7xl font-bold leading-none text-white">
        ...
        <div className="bg-soft rounded-lg py-12 text-center my-10">
          <div>
            <p>Discover Keys with Our Fun Guide to Property Deals</p>
          </div>
          <div className="mt-2">
        ...
        <Modal width={1250} blur animationDuration={200} open={isOpenGuide} hideIcon onOpenChange={setIsOpenGuide}>
          <div className="p-5">
            ...
            <p className="text-sm mt-2 font-semibold">Welcome to our all-inclusive guide to finding your perfect property! Whether you're seeking <br /> a long-term home, mid-term, a short-term retreat, or ready to make a purchase, we're here<br /> to support you through every step of the journey.</p>
            <p className="mt-5 text-lg font-bold underline">Rent Guide</p>
            <div className="mt-1 grid grid-cols-5 gap-x-4">
