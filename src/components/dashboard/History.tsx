    ...
    return (
        <div>
            ...
            <div>
                ...
                <div className="space-y-2 mb-4">
                    {Array.from({ length: 2 }).map((_, index) => (
                        <div onClick={() => { setIsOpenReview(true) }} key={index} className="cursor-pointer hover:scale-[1.015] duration-300 transition-all flex items-center justify-between p-2 bg-white rounded-md shadow-md">
                ...
                <div className="space-y-2">
                    {Array.from({ length: 5 }).map((_, index) => (
                        <div onClick={() => { router.push('/detail/rent'); }} key={index} className="cursor-pointer hover:scale-[1.015] duration-300 transition-all flex items-center justify-between p-2 bg-white rounded-md shadow-md">
                            <div className="flex items-center">
                                <img alt="Image of a modern luxury villa with a pool in Umalas" className="w-20 h-12 object-cover rounded-md mr-4" height="100" src="https://storage.googleapis.com/a1aa/image/736u630ayToeUyb1VrDuSyOIcbfgJlYdebRynrQZnAgWXhWnA.jpg" width="100" />
                                <div>
                                    <div className="font-semibold text-sm text-gray-800">
            ...
            <Modal onClose={() => {
                setActiveButtons([]);
                setRating(0);
            }} blur animationDuration={200} open={IsOpenReview} hideIcon onOpenChange={setIsOpenReview}>
                <div>
