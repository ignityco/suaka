...
const MyProperty = () => {
    ...
    return (
        <div>
            <div className='w-full bg-soft rounded-xl p-5 md:flex md:items-center md:justify-between'>
                <div>
                ...
                <div>
                    <button onClick={() => { router.push('/dashboard/profile/upload') }} className='mt-2 lg:mt-0 px-4 py-2 bg-second hover:bg-second/85 duration-300 transition-all rounded-lg text-white'>Upload</button>
                </div>
            </div>
            ...
            <div className="space-y-2 mb-4">
                <div className="cursor-pointer hover:scale-[1.015] duration-300 transition-all md:flex md:items-center md:justify-between p-2 bg-white rounded-md shadow-md">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4 md:ml-0 block md:hidden text-gray-500 text-sm">
                    ...
                    <div className='md:hidden flex items-center justify-between mt-2 space-x-1'>
                    ...
                    <div className="hidden md:block text-center flex items-center space-x-1">
                        <button onClick={() => { router.push('/dashboard/profile/edit/1') }} className="relative px-3 text-sm rounded-full border border-primary hover:bg-primary hover:text-white duration-300 transition-all p-1">
                            Edit
                        </button>
                        <button onClick={() => { setIsOpenDelete(true) }} className="relative px-3 text-sm rounded-full border border-primary hover:bg-primary hover:text-white duration-300 transition-all p-1">
            ...
            <Modal onClose={() => { }} position="center" blur animationDuration={200} open={IsOpenDelete} hideIcon onOpenChange={setIsOpenDelete}>
                <div>
            ...
            <Modal onClose={() => { }} position="center" blur animationDuration={200} open={IsOpenListing} hideIcon onOpenChange={setIsOpenListing}>
                <div>
